...
<head>
    ...
    <title>Sản Phẩm Nổi Bật - PinkyCloud</title>
...
<body>
    ...
    <main class="container my-5">
        <div class="text-center mb-5">
            ...
            <p class="text-muted">Những sản phẩm được yêu thích nhất tại PinkyCloud</p>
        </div>
        ...
        <div class="results-header mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-1">
                        <i class="fas fa-box-open me-2"></i>Tổng số sản phẩm
                    </h5>
                    <small class="text-muted">
                        <c:choose>
                            ...
                            <c:otherwise>
                                Hiển thị ${(currentPage-1)*pageSize + 1}-${(currentPage-1)*pageSize + featuredProducts.size()} 
        ...
        <c:choose>
            <c:when test="${empty featuredProducts}">
                <div class="alert alert-info text-center">
                    ...
                    <h5>Chưa có sản phẩm nổi bật nào</h5>
                ...
                <div class="product-grid mb-5">
                    <c:forEach var="product" items="${featuredProducts}">
                        <div class="product-card"
                            ...
                            <div style="position: absolute; top: 10px; right: 10px; background: linear-gradient(135deg, #ffd700, #ffed4e); color: #333; padding: 6px 12px; border-radius: 20px; font-size: 0.75rem; font-weight: 700; z-index: 10; box-shadow: 0 3px 10px rgba(255, 215, 0, 0.5);">
