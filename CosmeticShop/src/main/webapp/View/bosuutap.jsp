...
<body>
    ...
    <main class="container my-5">
        <div class="text-center mb-4">
            <h2 class="fw-bold" style="color: #f76c85; font-family: 'Times New Roman', Times, serif;">BỘ SƯU TẬP SẢN PHẨM</h2>
            <p>Khám phá những sản phẩm làm đẹp tốt nhất dành cho bạn.</p>
            
            <%-- Nút để thêm sản phẩm mới --%>
            <a href="${pageContext.request.contextPath}/products?action=new" class="btn btn-lg mt-3" style="background-color: #f76c85; color: white;">
                ...
                <div class="product-card">
                    ...
                    <div class="product-card-body">
                        ...
                        <div class="action-buttons">
                            <a href="${pageContext.request.contextPath}/products?action=edit&id=${product.productId}" class="btn btn-sm btn-outline-primary">
                                <i class="fas fa-edit"></i> Sửa
                            </a>
                            <a href="${pageContext.request.contextPath}/products?action=delete&id=${product.productId}" class="btn btn-sm btn-outline-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này không?');">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="#" class="text-white text-decoration-none">Sức khỏe và làm đẹp</a></li>
